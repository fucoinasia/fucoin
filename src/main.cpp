...
uint256 hashGenesisBlock("0x000000004c8b6559b260bb782d7a1c4048c59b01eb191e05a5db1d89e26d669c");
...
const string strMessageMagic = "Fu Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000004c8b6559b260bb782d7a1c4048c59b01eb191e05a5db1d89e26d669c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1418839145;
        block.nBits    = 486604799;
        block.nNonce   = 1178717947;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FuMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FuMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running FuMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
